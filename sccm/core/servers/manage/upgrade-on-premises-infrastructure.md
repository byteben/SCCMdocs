...
This is only required if upgrading from Server 2008 R2 because of a WSUS version change. This is not a requirement if upgrading from Server 2012R2 or higher
